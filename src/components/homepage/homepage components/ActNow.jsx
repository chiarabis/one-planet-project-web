...
import { faBicycle, faBuilding, faCartShopping, faChevronCircleDown, faChevronCircleRight, faCow, faIndustry, faLeaf, faSeedling, faSmog, faSolarPanel, faTemperatureArrowDown, faTemperatureLow, faTree, faTreeCity, faWheatAwn } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
        <div className="flex flex-col">
            ...
            <div className="flex flex-col items-center mx-4 md:mx-12">     
                <h1 className="uppercase encode-sans text-red text-center font-semibold text-3xl my-6 md:mt-0">Act now for planet</h1>
                ...
                <div className='encode-sans grid grid-cols-1 md:grid-cols-2 items-center gap-x-8 gap-y-8 my-8 w-full'>
                    ...
                    <div className='flex flex-row justify-center w-full relative m-6'>
                        <div className='gallery'>
                            <img src='global-warming/glaciers.jpg' onMouseEnter={() => handleMouseEnterImg("glaciers")}
                            onMouseLeave={handleMouseLeaveImg}></img>
                            <img src='global-warming/air-pollutants.jpg' onMouseEnter={() => handleMouseEnterImg("air-pollutants")}
                            onMouseLeave={handleMouseLeaveImg}></img>
                            <img src='global-warming/ocean.jpg' onMouseEnter={() => handleMouseEnterImg("ocean")}
                            onMouseLeave={handleMouseLeaveImg}></img>
                            <img src='global-warming/habitats-loss.jpg' onMouseEnter={() => handleMouseEnterImg("habitats-loss")}
                            onMouseLeave={handleMouseLeaveImg}></img>
                            <img src='global-warming/extreme-weather.png' onMouseEnter={() => handleMouseEnterImg("extreme-weather")}
                            onMouseLeave={handleMouseLeaveImg}></img>
                            <img src='global-warming/desertification.jpg' onMouseEnter={() => handleMouseEnterImg("desertification")}
                            onMouseLeave={handleMouseLeaveImg}></img>
                        </div>
                    </div>
                ...
                <div className="my-8 w-full">
                    <div className="encode-sans flex flex-col items-center">
                        <p className="p-4 text-center glow">How can we reduce our impact and what can we ask to our government?</p>
